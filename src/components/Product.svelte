...
import SectionWrapper from "./SectionWrapper.svelte";
  let productFeatures = [
    ...
    {
      featureList: ["Select your preferences",
    ...
    {
      featureList: ["Eliminating guesswork",
                "Save time",
...
<SectionWrapper id="product">
  <div class="flex flex-col gap-10 sm:gap-14 md:gap-24 flex-1 items-center justify-center pb-10 md:pb-14">
    <div class="flex flex-col gap-2">
      ...
      <h3 class="text-4xl sm:text-5xl md:text-6xl max-w-[1000px] mx-auto w-full font-semibold to-current">Features For Everyone</h3>
    </div>
